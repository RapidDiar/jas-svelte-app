...
<div class="container" style="height: 570px;">
    ...
    <div class="row justify-content-center mt-5 align-content-stretch">
        <div class="col text-center">
            <img src="https://cdn.iconscout.com/icon/free/png-512/metamask-2728406-2261817.png" class="w-25"/>
        </div>
    </div>
    <div class="row justify-content-center mt-5">
        <div class="col text-center">
            {#if metamask === 'none'}
                ...
                <a class="btn btn-primary mt-3" href="https://chrome.google.com/webstore/detail/metamask/nkbihfbeogaeaoehlefnkodbefgpgknn?hl=en">Metamask for Chrome</a>
            ...
            {:else if metamask === 'connected'}
                ...
                <p>Wallet address <a href="https://rinkeby.etherscan.io/address/{currentAccount}"> {currentAccount} </a> </p> 
            {/if}
