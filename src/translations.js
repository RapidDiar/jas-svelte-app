export default {
	en: {
		navbar: {
			input_search: 'Search',
			button_marketplace: 'Marketplace',
		...
		main: {
			...
			nft: {
				...
				text: {
					...
					connect:
						'Log in to your account and connect to the Metamask wallet located in the Profile.',
					upload:
		...
		addNft: {
			...
			text: {
				card: 'Preview',
				text_image: 'Download image',
				text_information: 'Add information',
	...
	ru: {
		...
		main: {
			...
			nft: {
				...
				text: {
					register:
						'Вам необходимо зарегистрироваться на сайте kazpatent.kz и подайте заявку на авторство картины.',
					connect:
						'Войдите в свою учетную запись и подключитесь к кошельку Metamask, расположенному в Профиле.',
					upload:
						'Загрузите свою работу, добавьте заголовок и описание и настройте свои NFT с помощью свойств, статистики и открываемого контента.',
					list:
						'Выбирайте между аукционами, объявлениями с фиксированной ценой и объявлениями со снижающейся ценой. Вы сами выбираете, как вы хотите продавать свои NFT.'
				}
			}
		},
		auth: {
		...
		addNft: {
			...
			text: {
				...
				text_image: 'Загрузите изображение',
				text_information: 'Добавьте информацию',
		...
		footer: {
			...
			text: {
				stay_in_the_loop_text:
					'Присоединяйтесь к нашему списку рассылки, чтобы быть в курсе наших новейших выпусков функций, обновлений NFT, а также советов и рекомендаций',
