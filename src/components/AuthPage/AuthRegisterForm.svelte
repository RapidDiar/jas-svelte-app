...
<div class="tab-pane fade" id="pills-register" role="tabpanel" aria-labelledby="tab-register">
	...
	<form on:submit|preventDefault={onRegister}>
		...
		<!-- Email input -->
		<div class="input-group mb-3">
			<span class="input-group-text border-1 border-end-0 bg-light"><i class="fas fa-at" /></span>
			<input
				type="email"
				class="form-control border-start-0"
				placeholder="email"
		...
		<!-- Password input -->
		<div class="input-group mb-3">
			<span class="input-group-text border-1 border-end-0 bg-light"><i class="fas fa-key" /></span>
			<input
				type="password"
